...
func nextOrder(column, currentCol, currentOrd string) string {
	if column == currentCol && currentOrd == "asc" {
		return "desc"
	}
	return "asc"
}

func SortableHeader(name, label, currentCol, currentOrd string, mostrar bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 = []any{map[string]bool{
			"sortable":    true,
			"sorted-asc":  currentCol == name && currentOrd == "asc",
			"sorted-desc": currentCol == name && currentOrd == "desc",
		}}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/sortableheader.templ`, Line: 1, Col: 0}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/sortableheader.templ`, Line: 28, Col: 17}
		}
